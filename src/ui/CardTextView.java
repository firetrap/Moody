...
public class CardTextView extends TextView {
	...
	public CardTextView(Activity activity, int action, String setText, ObjectSearch params, String searchQuery) {
		super(activity);
		...
		case R.id.MOODY_SEARCH_TITLE_ACTION_MODULE:
			...
			setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					insideTopicsFrag.setArguments(bundle);
					fragmentTransaction.addToBackStack(null);
					fragmentTransaction.replace(R.id.mainFragment, insideTopicsFrag, params.getCourseId() + params.getTopicId());
					fragmentTransaction.commit();
