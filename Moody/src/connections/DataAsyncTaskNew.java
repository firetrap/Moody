 ...
 *
 */
public class DataAsyncTaskNew extends AsyncTask<Object, Void, Object> {
	Object								jObj	= null;
	...
	public DataAsyncTaskNew(Context context, MainActivityAsyncInterface mainActivityInterface) {
		this.context = context;
		dialog = new ProgressDialog(context);
		this.mainActivityInterface = mainActivityInterface;
	}

	public DataAsyncTaskNew(Context context, UserDetailsInterface userDetailsInterface) {
		this.context = context;
		dialog = new ProgressDialog(context);
	...
	protected void onPostExecute(Object obj) {
		...
		case CORE_ENROL_GET_USERS_COURSES:
			if (parentActivity.equalsIgnoreCase(MainActivity.class.getSimpleName()))
				mainActivityInterface.coursesAsyncTaskResult(obj);
		...
		case CORE_USER_GET_USERS_BY_ID:
			...
			if (parentActivity.equalsIgnoreCase(UserDetailsActivity.class.getSimpleName()))
				userDetailsInterface.userAsyncTaskResult(obj);
